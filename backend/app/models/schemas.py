...
class BloodRequestCreate(BaseModel):
    ...
    location_source: LocationSourceEnum = LocationSourceEnum.GPS
    ...
    @field_validator("patient_name", "requester_phone", mode="before")
    @classmethod
    def normalize_string_defaults(cls, v: Any, info) -> str:
        if not v or not str(v).strip():
            ...
            return defaults.get(info.field_name, "Emergency Patient")
        return str(v).strip()
