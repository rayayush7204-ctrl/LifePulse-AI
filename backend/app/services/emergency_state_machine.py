...
VALID_TRANSITIONS: Dict[str, list] = {
    "CREATED": ["AI_PROCESSING", "SEARCHING", "CANCELLED"],
    "AI_PROCESSING": ["VALIDATING", "SEARCHING", "CANCELLED"],
    "VALIDATING": ["SEARCHING", "CANCELLED"],
    "SEARCHING": ["SEARCHING", "MATCHING", "CANCELLED"],
    "MATCHING": ["RING1", "CANCELLED"],
    "RING1": ["RING2", "DONOR_ACCEPTED", "WAITING", "CANCELLED"],
    "RING2": ["WAITING", "DONOR_ACCEPTED", "CANCELLED"],
    "WAITING": ["DONOR_ACCEPTED", "CLOSED", "CANCELLED"],
    "DONOR_ACCEPTED": ["TRACKING", "MATCHING", "CANCELLED"],
    "TRACKING": ["ARRIVING", "ARRIVED", "MATCHING", "CANCELLED"],
    "ARRIVING": ["ARRIVED", "MATCHING", "CANCELLED"],
