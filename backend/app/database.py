...
class DatabaseRepository:
    ...
    def create_request(self, req_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        req = EmergencyRequestDB(
            ...
            location_name=req_data.get("location_name", "Current Location"),
            location_address=req_data.get("location_address", ""),
            location_source=req_data.get("location_source", "gps"),
